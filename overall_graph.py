...
file_location = "C:\\Users\\Amine\\Desktop\\overall_graph.xlsx"
...
print ("The number of shippers is", len(List_shippers_degrees))
...
##worksheet.write(3,1, nx.number_of_nodes(G))
##worksheet.write(0,2, "Number of consignees")
##worksheet.write(3,2, len(List_consignees_degrees))
##worksheet.write(0,3, "Number of shippers")
##worksheet.write(3,3, nx.number_of_nodes(G)-len(List_consignees_degrees))
##worksheet.write(0,4, "Number of edges")
##worksheet.write(3,4, nx.number_of_edges(G))
##worksheet.write(0,5, "Is the graph bipartite ?")
##worksheet.write(3,5, nx.is_bipartite(G))
##worksheet.write(0,6, "The highest degree of a consignee")
##worksheet.write(3,6, np.max(List_consignees_degrees))
##worksheet.write(0,7, "The consignee with the highest degree is")
##worksheet.write(3,7, List_consignees_and_degrees[np.argmax(List_consignees_degrees)][0])
##worksheet.write(0,8, "The mean degree is")
##worksheet.write(3,8, np.mean(List_degrees))
##worksheet.write(0,9, "The standard deviation of the degree distribution is")
##worksheet.write(3,9, np.std(List_degrees))
##worksheet.write(0,10, "The median degree is")
##worksheet.write(3,10, np.median(List_consignees_degrees))
##worksheet.write(0,11, "The 25 percentile is ")
##worksheet.write(3,11, np.percentile(List_consignees_degrees,25))
##worksheet.write(0,12, "The 75 percentile is")
##worksheet.write(3,12, np.percentile(List_consignees_degrees,75))
##worksheet.write(0,13, "The number of connected components is")
##worksheet.write(3,13, nx.number_connected_components(G))
##worksheet.write(0,14, "The ratio of shippers by consignees is")
##worksheet.write(3,14, (nx.number_of_nodes(G)-len(List_consignees_degrees))/len(List_consignees_degrees))
##worksheet.write(0,15, "The ratio of edges by nodes is")
##worksheet.write(3,15, nx.number_of_edges(G)/nx.number_of_nodes(G))
##worksheet.write(0,16, "The average bipartie clustering coefficient is")
###worksheet.write(3,16, bipartite.average_clustering(G))
##worksheet.write(0,17, "The number of consignees working with one shipper is")
##worksheet.write(3,17, nb_consignees_degree_one(G))
##worksheet.write(0,18, "The size of the max connected component is")
##worksheet.write(3,18, nx.number_of_nodes(giant))
##
##
##workbook.close()
##
